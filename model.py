...
class Model:
    ...
    def inference(self):
        ...
        self.high_score = tf.sigmoid(self.high_score)
        self.low_score = tf.sigmoid(self.low_score)

        score = self.high_level_score_coefficient * self.high_score + (1 - self.high_level_score_coefficient) * self.low_score
        return score
